...
int desired_speed[5]={10,10,10,10,10};
int last_angle[5];
int overflowNum[5] = {0,0,0,0,0};
int angle_sum[5];
pid_struct_t ver_pid[7];
pid_struct_t pos_pid[7];
/* USER CODE END PV */
...
/*******************************************************************************************
  ...
  * @Date     2024/6/3
 *******************************************************************************************/
void motor1_control_cw_90(int ID)
{
	target_position[ID] += 90;
}
...
/*******************************************************************************************
  ...
  * @Date     2024/6/3
 *******************************************************************************************/
void motor_control_aw_90(int ID)
{
